...
const Dashboard = () => {
  ...
  return (
    ...
    >
      ...
      >
        {filteredCourses.map((course,i)=>(<div key={i} className='course text-white h-[52vh] w-[18vw] bg-[#1c263c] rounded-lg shadow-lg shadow-black cursor-pointer hover:scale-101 hover:transition-all flex flex-col items-center justify-between gap-2'
        style={{
          padding:"2% 1%"
        }}
